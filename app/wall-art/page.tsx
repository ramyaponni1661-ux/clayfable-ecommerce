...
import { Star, Heart, ShoppingCart, Filter, Palette, Frame, Sparkles, Home, Award, Users, Shield, Truck } from "lucide-react"
...
export default function WallArtPage() {
  ...
  const filteredProducts = selectedStyle === "all"
    ? wallArtProducts
    : wallArtProducts.filter(product => product.style === selectedStyle)
