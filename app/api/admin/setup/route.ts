...
// Fixed to work with your existing database schema
      ...
      if (existingProfile) {
        ...
        if (profileError) {
          ...
          results.push({
            ...
            message: 'New admin user and profile created successfully'
          })
        }
      }
    }
...
export async function GET() {
  try {
    // Check current admin status using existing profiles
